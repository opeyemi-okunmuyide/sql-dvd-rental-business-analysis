...
Description:
This project analyzes a fictional DVD rental business using
SQL. It demonstrates techniques including:
- Filtering
- Aggregation
- GROUP BY
- CASE statements
...
Objective: Generate a directory of all staff members and their assigned
store locations.	
*/-----------------------------------------------------------
...
Objective:
Measure the diversity of each store's film inventory by
...
/*
-----------------------------------------------------------
SECTION 3 - CUSTOMER & SALES ANALYSIS
-----------------------------------------------------------
*/
...
/*
-----------------------------------------------------------
SECTION 4 - ADVISOR & INVESTOR REQUESTS
-----------------------------------------------------------
*/
